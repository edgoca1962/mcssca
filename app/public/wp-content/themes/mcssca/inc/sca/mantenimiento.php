 ...
 * 
 *****************************************************************************/
if (!function_exists('mcssca_vigencia_acuerdos')) {
   function mcssca_vigencia_acuerdos()
   {
 ...
 * 
 *****************************************************************************/
function mcssca_registrar_comite()
{
...
add_action('wp_ajax_agregar_comite', 'mcssca_registrar_comite');

function mcssca_editar_comite()
{
...
add_action('wp_ajax_editar_comite', 'mcssca_editar_comite');

function mcssca_eliminar_comite()
{
...
add_action('wp_ajax_eliminar_comite', 'mcssca_eliminar_comite');
/******************************************************************************
 * 
 * 
 ...
 * 
 *****************************************************************************/
function mcssca_registrar_acta()
{
   //Validación de seguridad
...
add_action('wp_ajax_agregar_acta', 'mcssca_registrar_acta');
/*
function mcssca_editar_acta()
{
   //Validación de seguridad
...
add_action('wp_ajax_editar', 'mcssca_editar_acta');
*/

function mcssca_eliminar_acta()
{
...
add_action('wp_ajax_eliminar_acta', 'mcssca_eliminar_acta');
/******************************************************************************
 * 
 * 
 ...
 * 
 *****************************************************************************/
function mcssca_registrar_acuerdo()
{
   //Validación de seguridad
...
add_action('wp_ajax_agregar_acuerdo', 'mcssca_registrar_acuerdo');

function mcssca_editar_acuerdo()
{
   //Validación de seguridad
...
add_action('wp_ajax_editar_acuerdo', 'mcssca_editar_acuerdo');

function mcssca_eliminar_acuerdo()
{
...
add_action('wp_ajax_eliminar_acuerdo', 'mcssca_eliminar_acuerdo');
/******************************************************************************
 * 
 * 
 ...
 * 
 *****************************************************************************/
function mcssca_mantener_membresia()
{
   //Validación de seguridad
...
add_action('wp_ajax_mantener_membresia', 'mcssca_mantener_membresia');
/******************************************************************************
 * 
 * 
...
function verAcuerdos()
{
   ...
   $verAcuerdosComite = [];
   if (mcssca_get_page_att()['userAdmin']) {
...
function mcssca_pre_get_posts($query)
{
...
add_action('pre_get_posts', 'mcssca_pre_get_posts');
