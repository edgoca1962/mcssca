...
add_action('wp_ajax_nopriv_ingresar', 'mcs_sca_ingresar');

function mcs_sca_cambiar_clave()
{
...
add_action('wp_ajax_cambiar_clave', 'mcs_sca_cambiar_clave');
