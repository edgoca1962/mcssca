...
<div class="row">
   <div class="col-xl-8">
      <h4 class="mb-5 animate__animated animate__fadeInLeft"><?php echo mcssca_vigencia_acuerdos()['vigenciaAcuerdos'] . mcssca_vigencia_acuerdos()['tituloComite'] . mcssca_vigencia_acuerdos()['tituloUsuario'] ?></h4>
      <?php $postsvigencia = new WP_Query(mcssca_vigencia_acuerdos()['argsvigencia']) ?>
         ...
         <?php while ($postsvigencia->have_posts()) : ?>
            ...
            <div class="card mb-5 shadowcss" style="background: linear-gradient(to right, rgba(64, 154, 247, 1), rgba(43, 170, 177, 1)) !important; color: #fff;">
               <div class="card-header pt-4 d-flex">
                  ...
                  <div class="col">
                     <h6><?php echo (get_post_meta($post->ID, '_vigente', true)) ? mcssca_vigencia_acuerdos()['status'] : 'Ejecutado el: ' . get_post_meta($post->ID, '_f_seguimiento', true) ?></h6>
                  </div>
               </div>
               <div class="card-body">
