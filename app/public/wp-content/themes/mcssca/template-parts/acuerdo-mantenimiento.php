      ...
      <div class="modal-content text-black" style="background: rgba(255, 224, 0, 0.9)">
         <div class="modal-header">
            <h1 class="modal-title fs-5" id="lbl_mantenimiento">
               Agregar Acuerdo: <?php echo mcssca_get_page_att($post->post_type)['subtitulo'] ?>
            </h1>
            ...
            <form id="agregar_acuerdo" class="row g-3 needs-validation" novalidate>
               <div class="row gy-2 gx-3 align-items-center">
                  <div class="col-md-4 mb-3">
                     ...
                     <input type="number" class="form-control" id="n_acuerdo" name="n_acuerdo" value="<?php echo mcssca_get_page_att($post->post_type)['consecutivo'] ?>" data-n_acuerdos="<?php echo mcssca_get_page_att($post->post_type)['n_acuerdos'] ?>" required>
               ...
               <input type="hidden" name="comite_id" value="<?php echo mcssca_get_page_att($post->post_type)['comite_id'] ?>">
               <input type="hidden" name="acta_id" value="<?php echo mcssca_get_page_att($post->post_type)['acta_id'] ?>">
               <input type="hidden" name="nombre_comite" value="<?php echo mcssca_get_page_att($post->post_type)['titulo_comite'] ?>">
               <input type="hidden" name="n_acta" value="<?php echo mcssca_get_page_att($post->post_type)['subtitulo'] ?>">
            ...
            <form id="editar_acuerdo" class="needs-validation" novalidate>
               <div class="row gy-2 gx-3 align-items-center">
                  <div class="col-md-4 mb-3">
                     ...
                     <input id="f_compromiso" type="date" class="form-control" name="f_compromiso" value="<?php echo get_post_meta(get_the_ID(), '_f_compromiso', true) ?>">
                  </div>
                  <div class="col-md-4 mb-3">
                     <div class="form-check form-switch pt-3">
